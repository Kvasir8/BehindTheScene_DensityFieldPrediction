...
class Projector:
    ...
    def compute_projections(self, xyz, train_cameras):  ## ! BTS
        """
    ...
    def compute_angle(self, xyz, query_camera, train_cameras):
        ...
        )  # [n_views, 4, 4]        ## camerea intrinsics which are the same for nv_
    ...
    def compute(self, xyz, query_camera, train_imgs, train_cameras, featmaps):
        ...
        """
        assert (
            (train_imgs.shape[0] == 1) and (train_cameras.shape[0] == 1) and (query_camera.shape[0] == 1)
        ...
        normalized_pixel_locations = pixel_locations

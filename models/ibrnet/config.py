...
def config_parser():
    ...
    ## kitti360 dataset
    parser.add_argument("--comment", type=str, default="", help="kitti360")
    parser.add_argument("--type", type=str, default="KITTI_360_IBR", help="kitti360")
    ...
    parser.add_argument("--z_near", type=float, default=0.1, help="z_near")
    parser.add_argument("--z_far", type=float, default=5, help="z_far")
